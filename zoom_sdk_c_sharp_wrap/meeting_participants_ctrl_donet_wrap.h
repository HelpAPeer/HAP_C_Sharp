...
public
	delegate void onUserJoin(array<unsigned int> ^ lstUserID);
public
	delegate void onUserLeft(array<unsigned int> ^ lstUserID);
public
	delegate void onHostChangeNotification(unsigned int userId);

public
	delegate void onCoHostChangeNotification(unsigned int userId, bool isCoHost);

public
	delegate void onLowOrRaiseHandStatusChanged(bool bLow, unsigned int userid);
public
	delegate void onUserNameChanged(unsigned int userId, String ^ userName);

public
	interface class IMeetingParticipantsControllerDotNetWrap
	{
	public:
		...
		void Remove_CB_onCoHostChangeNotification(onCoHostChangeNotification ^ cb);
...
private
	ref class CMeetingParticipantsControllerDotNetWrap sealed : public IMeetingParticipantsControllerDotNetWrap
	{
	public:
